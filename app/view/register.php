...
<div class="form-group ">
  ...
  <input type="text"
    class="form-control input-lg" name="name" id="" aria-describedby="helpId" placeholder="User Name" autocomplete="off">
</div>
<div class="form-group ">
  <label for="">Email</label>
  <input type="text"
    class="form-control input-lg" name="email" id="" aria-describedby="helpId" placeholder="User Name" autocomplete="off">
</div>
<div class="form-group ">
